...
## 💡 The Solution: "Sales Dashboard Tableu.pdf"
...
## 🏗️ Data Architecture
To ensure scalability and performance, I followed a structured BI pipeline:
1.  **Data Modeling:** Implemented a Star Schema by classifying raw data into Fact (Orders) and Dimension (Products, Location) tables.
2.  **Logic Layer:** Created advanced Calculated Fields to handle YoY growth and seasonal variances without slowing down the dashboard.
3.  **Optimization:** Used Level of Detail (LOD) expressions for fixed KPI calculations regardless of the filter depth.
